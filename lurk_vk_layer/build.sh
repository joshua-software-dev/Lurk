...
# fpm -f -t deb    -a x86    -p "vk_layer_lurk-$ver-x86.deb"            --version "$ver" lib32=/usr/
# fpm -f -t rpm    -a x86    -p "vk_layer_lurk-$ver-x86.rpm"            --version "$ver" lib32=/usr/
# fpm -f -t pacman -a x86    -p "vk_layer_lurk-$ver-x86.pkg.tar.zst"    --version "$ver" lib32=/usr/
# fpm -f -t tar    -a x86    -p "vk_layer_lurk-$ver-x86.tar.gz"         --version "$ver" lib32=/usr/
# fpm -f -t deb    -a x86_64 -p "vk_layer_lurk-$ver-x86_64.deb"         --version "$ver" lib64=/usr/
# fpm -f -t rpm    -a x86_64 -p "vk_layer_lurk-$ver-x86_64.rpm"         --version "$ver" lib64=/usr/
# fpm -f -t pacman -a x86_64 -p "vk_layer_lurk-$ver-x86_64.pkg.tar.zst" --version "$ver" lib64=/usr/
# fpm -f -t tar    -a x86_64 -p "vk_layer_lurk-$ver-x86_64.tar.gz"      --version "$ver" lib64=/usr/
